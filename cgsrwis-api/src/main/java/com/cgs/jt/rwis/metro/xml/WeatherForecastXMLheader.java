...
/**
 * Java bean that represents the <header> XML tag in the weather forecasts XML (Metro model input). 
...
public class WeatherForecastXMLheader {
	 ...
	 */	
	@JsonCreator
	public WeatherForecastXMLheader(
